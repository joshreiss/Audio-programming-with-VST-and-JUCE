...
/**
*/
class FMSynthesisAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    FMSynthesisAudioProcessor();
    ~FMSynthesisAudioProcessor() override;
...
private:
  ...
  float modulatorPhase = 0;           // Phase of the modulator, range 0 to 1
