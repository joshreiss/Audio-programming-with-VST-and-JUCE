...
/* This component scrolls a continuous waveform showing the audio that's
   ...
   ==> Taken from the JUCE Demo, needed change is #include "JuceHeader.h" instead of demo header!
   - additional change: boost * 3.0f instead of 10.0f seems to fit better
*/
