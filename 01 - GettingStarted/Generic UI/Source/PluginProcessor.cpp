...
const juce::String VTSProcessor::getName() const
{
    return JucePlugin_Name;
}
bool VTSProcessor::acceptsMidi() const
{
...
bool VTSProcessor::producesMidi() const
{
...
bool VTSProcessor::isMidiEffect() const
{
...
double VTSProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
int VTSProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int VTSProcessor::getCurrentProgram()
{
    return 0;
}

void VTSProcessor::setCurrentProgram (int index)
{
}

const juce::String VTSProcessor::getProgramName (int index)
{
    return {};
}

void VTSProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void VTSProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    // Use this method as the place to do any pre-playback
    // initialisation that you need..
}

void VTSProcessor::releaseResources()
{
...
bool VTSProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void VTSProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool VTSProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* VTSProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void VTSProcessor::getStateInformation(juce::MemoryBlock& destData)
{
...
void VTSProcessor::setStateInformation (const void* data, int sizeInBytes)
{
